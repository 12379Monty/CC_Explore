...
```{r comp-models-trainAccuracy, cache=TRUE, cache.vars='', eval=T}
...
Compare Tables \@ref(tab:comp-models-OOSTrainAccuracy)
and \@ref(tab:comp-models-testAccuracy) with
Figures \@ref(fig:comp-models-CompROCOOSTrain) and 
\@ref(fig:comp-models-CompOOSSet.TrainProbClass1).


```{r comp-models-OOSTrainAccuracy, cache=TRUE, cache.vars='', eval=T}
...
```{r comp-models-CompROCOOSTrain, message=F, warning=F, cache=FALSE, cache.vars='', fig.height=6, fig.width=11, eval=T, fig.cap='Out-of-sample Train: Average over Repeats'}
...
### Out-of-sample Train Set: Individual Repeats

```{r comp-models-CompROCIndivOOSTrain, warning=F, message=F, cache=FALSE, cache.vars='Set.Train.indiv_osProbClass1.mtx', fig.height=6, fig.width=11, eval=T,fig.cap='Out-of-sample Train: Individual Repeats'}
...
```{r comp-models-CompOOSSet.TrainProbClass1, cache=FALSE, cache.vars='', fig.height=12, fig.width=12, eval=T, fig.cap='Predicted Probabilities'}
