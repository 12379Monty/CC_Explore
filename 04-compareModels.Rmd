...
### Training Data ROC
```{r comp-models-CompROCTrain, cache=TRUE, cache.vars='Set.Train.roc.mtx.lst', fig.height=6, fig.width=11, eval=T}
### BREAK CACHE
...
```{r comp-models-CompROCOOSTrain, cache=FALSE, cache.vars='', fig.height=6, fig.width=11, eval=T}
### BREAK CACHE
 suppressMessages(require(pROC))
 # Get predicted probabilities
...
```{r comp-models-CompROCIndivOOSTrain, cache=FALSE, cache.vars='Set.Train.indiv_osProbClass1.mtx', fig.height=6, fig.width=11, eval=T}
### BREAK CACHE
 suppressMessages(require(pROC))
...
```{r comp-models-CompOOSSet.TrainProbClass1, cache=FALSE, cache.vars='', fig.height=12, fig.width=12, eval=T}
### BREAK CACHE
...
```{r comp-models-readGeneSets, echo=T, eval=T}
### BREAK CACHE
